...
# Created by write_sdc on Sat Nov 20 00:21:44 2021
...
create_clock [get_ports clk]  -name MY_CLK  -period 5.6  -waveform {0 2.8}
...
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {DIN_3[7]}]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {DIN_3[6]}]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {DIN_3[5]}]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {DIN_3[4]}]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {DIN_3[3]}]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {DIN_3[2]}]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {DIN_3[1]}]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {DIN_3[0]}]
...
set_output_delay -clock MY_CLK  -max 0.5  [get_ports {DOUT_3[7]}]
set_output_delay -clock MY_CLK  -max 0.5  [get_ports {DOUT_3[6]}]
set_output_delay -clock MY_CLK  -max 0.5  [get_ports {DOUT_3[5]}]
set_output_delay -clock MY_CLK  -max 0.5  [get_ports {DOUT_3[4]}]
set_output_delay -clock MY_CLK  -max 0.5  [get_ports {DOUT_3[3]}]
set_output_delay -clock MY_CLK  -max 0.5  [get_ports {DOUT_3[2]}]
set_output_delay -clock MY_CLK  -max 0.5  [get_ports {DOUT_3[1]}]
set_output_delay -clock MY_CLK  -max 0.5  [get_ports {DOUT_3[0]}]
